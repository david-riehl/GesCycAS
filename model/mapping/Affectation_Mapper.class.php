<?php
	class Affectation_Mapper extends Data_Mapper
	{
		private static $name = "Affectation";
		
		public static $fields = array(
			array('name' => 'id_utilisateur','type' => 'int','constraint' => 'NOT NULL'),
			array('name' => 'id_groupe','type' => 'int','constraint' => 'NOT NULL')
		);
		
		public static $primary_key = array('id_utilisateur','id_groupe');
