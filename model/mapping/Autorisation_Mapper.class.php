<?php
	class Autorisation_Mapper extends Data_Mapper
	{
		private static $name = "autorisation";
		
		public static $fields = array(
			array('name' => 'id_annee','type' => 'int','constraint' => 'NOT NULL'),
			array('name' => 'id_cours','type' => 'int','constraint' => 'NOT NULL')
		);
		
		public static $primary_key = array('id_annee','id_cours');
		public static $foreign_key = array(
			array('Foreign Key' => array('id_annee'), 'table' => 'annee', 'Primary Key' => array('id')),
			array('Foreign Key' => array('id_cours'), 'table' => 'cours', 'Primary Key' => array('id'))
		);
