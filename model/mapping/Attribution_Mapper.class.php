<?php
	class Attribution_Mapper extends Data_Mapper
	{
		private static $name = "attribution";
		
		public static $fields = array(
			array('name' => 'id_droit','type' => 'int','constraint' => 'NOT NULL'),
			array('name' => 'id_groupe','type' => 'int','constraint' => 'NOT NULL')
		);
		
		public static $primary_key = array('id_droit','id_groupe');
		public static $foreign_key = array(
			array('Foreign Key' => array('id_droit'), 'table' => 'droit', 'Primary Key' => array('id')),
			array('Foreign Key' => array('id_groupe'), 'table' => 'groupe', 'Primary Key' => array('id'))
		);
