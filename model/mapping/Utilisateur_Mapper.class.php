<?php
	class Utilisateur_Mapper extends Data_Mapper
	{
		private static $name = "Utilisateur";
		...
		public static $fields = array(
			...
			array('name' => 'prenom', 'type' => 'varchar', 'size' => 20,'constraint' => 'NOT NULL'),
			array('name' => 'email', 'type' => 'varchar', 'size' => 255),
			array('name' => 'login', 'type' => 'varchar', 'size' => 20,'constraint' => 'NOT NULL'),
			array('name' => 'password', 'type' => 'varchar', 'size' => 32,'constraint' => 'NOT NULL'),
			array('name' => 'actif', 'type' => 'tinyint', 'size' => 1,'constraint' => 'NOT NULL', 'default' =>0)
		);
