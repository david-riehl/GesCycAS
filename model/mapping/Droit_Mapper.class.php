<?php
	class Droit_Mapper extends Data_Mapper
	{
		private static $name = "droit";
		
		public static $fields = array(
			array('name' => 'id','type' => 'int','constraint' => 'NOT NULL','options' => 'AUTO_INCREMENT'),
			array('name' => 'nom', 'type' => 'varchar', 'size' => 20),
			array('name' => 'controleur', 'type' => 'varchar', 'size' => 20,'constraint' => 'NOT NULL'),
			array('name' => 'action', 'type' => 'varchar', 'size' => 20,'constraint' => 'NOT NULL', 'default'=>"'default'")
		);
