...
{/if}
			...
			<div id="main">
				...
				<form name="frm_classe_delete" action="" method="post">
					<input type="hidden" name="id" value="{$item.id}">
					<div id="main_item">
						<table>
							<tr><td>Êtes-vous sûrs de vouloir supprimer la classe suivant&nbsp;?</td></tr>
							<tr><td>
								<table>
				...
				<script type="text/javascript">
					document.forms["frm_classe_delete"].elements["btn_annuler"].focus();
					document.forms["frm_classe_delete"].elements["btn_annuler"].select();
				</script>
			</div>
